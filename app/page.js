    ...
    <div className="flex h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500/30">
            ...
            <div className="p-8">
              <div className="flex justify-between items-end mb-8">
                ...
                <div className="flex gap-3">
                  <button onClick={() => setIsRoomModalOpen(true)} className="bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-lg shadow-indigo-500/20 flex items-center gap-2">
                    <Icons.Plus />
                    Add Room
                  </button>
                </div>
          ...
          {activeTab === "bookings" && (
            <div className="p-0">
              <div className="p-8 border-b border-slate-800 flex justify-between items-center bg-slate-900/20">
                ...
                <button onClick={() => setActiveTab("rooms")} className="bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-lg shadow-indigo-500/20">New Booking</button>
              </div>
              {bookings.length === 0 ? (
            ...
            <div className="p-8">
              <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex gap-2">
                  <button onClick={() => setIsStaffModalOpen(true)} className="bg-indigo-600 hover:bg-indigo-500 px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-lg shadow-indigo-500/20 flex items-center gap-2">
                    <Icons.Staff />
                    Add Staff
                  </button>
                </div>
                    ...
                    <div key={member.id} className="bg-slate-950/40 border border-slate-800/50 p-6 rounded-4xl flex flex-col items-center text-center group hover:border-indigo-500/30 hover:bg-indigo-500/2 transition-all duration-500">
                      <div className="relative mb-5">
                        ...
                        <Image
                          ...
                          width={96}
                          height={96}
                          className="rounded-full border-4 border-slate-900 relative z-10"
                        />
                      ...
                      <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mb-6">{member.role}</p>
                      <div className="flex gap-2 w-full mt-auto">
                        <button className="flex-1 bg-slate-800/50 hover:bg-slate-700 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">Message</button>
                        <button className="flex-1 bg-indigo-600/10 text-indigo-400 hover:bg-indigo-600/20 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">Profile</button>
                      </div>
                    </div>
                  ))}
                </div>
                    ...
                    <div key={room.id} className="bg-slate-950/40 border border-amber-500/20 rounded-2xl p-6 group hover:border-amber-500/40 hover:bg-amber-500/5 transition-all duration-500">
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500 hover:text-white border border-emerald-500/20 hover:border-emerald-500 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2"
                        >
      ...
      {selectedRoom && (
        <div className="fixed inset-0 z-50 flex  items-center justify-center p-4">
          ...
          {/* Booking page */}
          <div className="relative bg-slate-900 border border-slate-800 w-full max-w-md rounded-[2.5rem] p-2 m-2 shadow-2xl animate-in zoom-in-95 duration-300">
            <button
              ...
              {selectedRoom.status === "Available" ? (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-indigo-500/5 rounded-2xl border border-indigo-500/20">
                      <p className="text-[10px] font-black uppercase tracking-widest text-indigo-400 mb-2">ID Card Number</p>
                      <input
                        type="text"
                        value={idCard}
                    ...
                    <div className="p-4 bg-indigo-500/5 rounded-2xl border border-indigo-500/20">
                      <p className="text-[10px] font-black uppercase tracking-widest text-indigo-400 mb-2">Phone Number</p>
                      <input
                        type="tel"
                        value={phoneNumber}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-indigo-500/5 rounded-2xl border border-indigo-500/20">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 scheme-dark"
                      />
                    </div>
                    <div className="p-4 bg-indigo-500/5 rounded-2xl border border-indigo-500/20">
                ...
                <div className="p-4 bg-slate-950/50 rounded-2xl border border-slate-800">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">Assigned Guest</p>
            ...
            <div className="flex gap-3">
              ...
              {selectedRoom.status === "Available" && (
                <button
                  ...
                  className="flex-1 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:hover:bg-indigo-600 py-4 rounded-2xl font-black text-xs uppercase tracking-widest text-white shadow-lg shadow-indigo-500/20 transition-all"
                >
                  Confirm Booking
                </button>
              )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <form onSubmit={handleAddStaff} className="relative bg-slate-900 border border-slate-800 w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="flex gap-3">
              ...
              <button type="submit" className="flex-1 bg-indigo-600 hover:bg-indigo-500 py-4 rounded-2xl font-black text-xs uppercase tracking-widest text-white shadow-lg shadow-indigo-500/20 transition-all">Add Member</button>
            </div>
          </form>
        </div>
      )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <form onSubmit={handleAddRoom} className="relative bg-slate-900 border border-slate-800 w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="flex gap-3">
              ...
              <button type="submit" className="flex-1 bg-indigo-600 hover:bg-indigo-500 py-4 rounded-2xl font-black text-xs uppercase tracking-widest text-white shadow-lg shadow-indigo-500/20 transition-all">Create Room</button>
            </div>
          </form>
        </div>
      )}
      ...
      {viewedBooking && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-slate-800 w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <button onClick={() => setViewedBooking(null)} className="w-full bg-indigo-600 hover:bg-indigo-500 py-4 rounded-2xl font-black text-xs uppercase tracking-widest text-white shadow-lg shadow-indigo-500/20 transition-all">Close Details</button>
          </div>
        </div>
      )}
